...
<head>
    ...
    <link rel="stylesheet" href="views/css/registro_style.css">
</head>
<body>
    ...
    <main class="register-container">
        ...
        <header class="header-logo">
            <img src="https://raw.githubusercontent.com/xzChris-Ibarra/Project-RobiNutri-WEB/refs/heads/main/Project%20RobiNutri/img/Logotipo%20Profesional%20RobiNutri.png" alt="RobiNutri Logo profesional con eslogan: ASISTENTE VIRTUAL DE IA PARA PROMOVER LA NUTRICIÓN INFANTIL" class="logo-image">
        </header>

        <div class="form-container">
            <form id="registerForm" method="POST" action="index.php?action=accionCuenta">
                <div class="form-row">
    ...
    <footer>
        <p>💡 RobiNutri es el chatbot que impulsa hábitos saludables en niños a través de inteligencia artificial y educación divertida. 🍎</p>
    </footer>

    <script src="views/js/registro_script.js"></script>
