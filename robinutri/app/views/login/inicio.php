...
<head>
    ...
    <link rel="stylesheet" href="views/css/inicio_style.css">
</head>
<body>
    ...
    <main class="login-container">
        ...
        <section class="login-area">
            ...
            <div class="login-form-container">
                <form method="POST" action="index.php?action=accionCuenta" class="login-form" id="loginForm">
                ...
                <p class="register-link">
                    ¿No tienes una cuenta? <a href="index.php?action=verRegistro">Regístrate aquí</a>
                </p>
            </div>
        </section>
